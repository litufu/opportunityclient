...
export const GET_INDUSTRIES = gql`
  query Industries($inputvalue: String!) {
    industries(inputvalue: $inputvalue){
      id
      name
    }
  }
...
function GetIndustries({ inputValue,getItemProps,highlightedIndex,selectedItem }) {
  ...
  return data.industries.map(({name: item}, index) => (
    <MenuItem
      key={item}
